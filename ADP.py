...
for (u1, v1, w1) in [(1,0,0)]:
    ...
    input_directory = r"D:\20cif\1_zone\test_cif_1"
    output_directory = r"D:\20cif\1_zone\test_100_random_angle"    
        ...
        if filename.endswith(".cif"):
            ...
            ###########################################        
               ...
               # Calculating delta1 for each number in hkl_same and checking the condition
                ...
                # Save the plot
                output_filename = os.path.splitext(filename)[0] + f"_u{u1}_v{v1}_w{w1}_2Dspot.png"
                output_filepath = os.path.join(output_directory, output_filename)
