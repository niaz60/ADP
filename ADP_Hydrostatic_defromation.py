...
Hydro = 0.9
# for example = 1.01, mean 1 percent expantion
# for example = 1.12, mean 12 percent expantion
# for example = 0.92, mean 8 percent compression
...
for (u1, v1, w1) in [(0,0,1)]:
    ...
    input_directory = r"D:\20cif\ttt\image\3\tt"
    output_directory = r"D:\20cif\ttt\image\3\tt"    
        ...
        if filename.endswith(".cif"):
            ...
            ###########################################        
               ...
               # Calculating delta1 for each number in hkl_same and checking the condition
                ...
                output_filename = os.path.splitext(filename)[0] + f"_1D_gaussian.xlsx"
                ...
                ##################################################################
                '''
                # ONLY Peak without gaussian_results_ONLY PEAKS_Defining how to generate excel file from 1D deawing in output
                
                # Convert matrix to NumPy array
                matrix_final_array = np.array(draw_I_Imax_percent)
                ...
                # Create an Excel writer and save the DataFrame
                output_filename = os.path.splitext(filename)[0] + "_1D_ONLY_PEAKS.xlsx"
                output_filepath = os.path.join(output_directory, output_filename)
                with pd.ExcelWriter(output_filepath) as writer:
                    df.to_excel(writer, sheet_name="Matrix", index=False)
                    # No need to call writer.save() as it is handled by the context manager
                ...
                # Save the plot
                output_filename = os.path.splitext(filename)[0] + f"_Ring_3D_gaussian.png"
                output_filepath = os.path.join(output_directory, output_filename)
                ...
                # Save the plot
                output_filename = os.path.splitext(filename)[0] + f"_Ring_2D_gaussina.png"
                output_filepath = os.path.join(output_directory, output_filename)
                plt.savefig(output_filepath, bbox_inches='tight')  # Add bbox_inches='tight' for a tighter fit
                plt.close()    
                print(f"Saved plot: {output_filename}")
                ...
                # Create an Excel writer and save the DataFrame
                output_filename = os.path.splitext(filename)[0] + f"_u{u1}_v{v1}_w{w1}_2D_feautres.xlsx"
                output_filepath = os.path.join(output_directory, output_filename)
                with pd.ExcelWriter(output_filepath) as writer:
                    df.to_excel(writer, sheet_name="Matrix", index=False)
                    # No need to call writer.save() as it is handled by the context manager
                ...
                # Save the plot
                output_filename = os.path.splitext(filename)[0] + f"_u{u1}_v{v1}_w{w1}_2Dspot_Hydro{Hydro}.png"
                output_filepath = os.path.join(output_directory, output_filename)
                ...
                # Save the plot
                output_filename = os.path.splitext(filename)[0] + f"_u{u1}_v{v1}_w{w1}_3Dgaussian.png"
                output_filepath = os.path.join(output_directory, output_filename)
                plt.savefig(output_filepath, bbox_inches='tight')  # Add bbox_inches='tight' for a tighter fit
                #plt.close()    
                print(f"Saved plot: {output_filename}")
                ...
                # Save the plot
                output_filename = os.path.splitext(filename)[0] + f"_u{u1}_v{v1}_w{w1}_2Dgaussian.png"
                output_filepath = os.path.join(output_directory, output_filename)
                plt.savefig(output_filepath, bbox_inches='tight')  # Add bbox_inches='tight' for a tighter fit
                #plt.close()   
                print(f"Saved plot: {output_filename}")
                ...
                # Create an Excel writer and save the DataFrame
                output_filename = os.path.splitext(filename)[0] + f"_u{u1}_v{v1}_w{w1}_2D_Zone_Axis.xlsx"
                output_filepath = os.path.join(output_directory, output_filename)
                with pd.ExcelWriter(output_filepath) as writer:
                    df.to_excel(writer, sheet_name="Matrix", index=False)
                    # No need to call writer.save() as it is handled by the context manager
