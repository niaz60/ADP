...
for (u1, v1, w1) in [(1,0,0)]:
    ...
    input_directory = r"D:\20cif\1_zone\_train_cif_500_random10000cif_remain"
    output_directory = r"D:\20cif\1_zone\_train_cif_500_random10000cif_patterns"    
        ...
        if filename.endswith(".cif"):
            ...
            ###########################################        
               ...
               # Calculating delta1 for each number in hkl_same and checking the condition
                ...
                points_transformed = rotate_points(points_transformed, random_angle)
                ...
                # Save the plot
                output_filename = os.path.splitext(filename)[0] + f"_u{u1}_v{v1}_w{w1}_{random_angle}.png"
                output_filepath = os.path.join(output_directory, output_filename)
